...
contract EnergyLogic is RoleManagement, TradableEntityLogic, TradableEntityContract {
    ...
    {        
        ...
        emit LogFlexibilityCreated( _id, agreementId, asset.marketProps.timeFrameFrom, asset.marketProps.timeFrameTo, _powerInW, asset.marketProps.averagePower, asset.marketProps.baselinePower, asset.marketProps.powerProfileURL, asset.assetGeneral.lastSmartMeterReadFileHash);
