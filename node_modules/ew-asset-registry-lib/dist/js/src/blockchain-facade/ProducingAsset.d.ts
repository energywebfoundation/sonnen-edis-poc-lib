...
export declare class Entity extends Asset.Entity implements OnChainProperties {
    ...
    getUrl(): string;
    sync(): Promise<Entity>;
    saveSmartMeterRead(meterReading: number, filehash: string, timeFrameFrom: number, timeFrameTo: number, averagePower: number, powerProfileURL: string): Promise<TransactionReceipt>;
}
