...
describe('AssetConsumingLogic Facade', () => {
    ...
    */
    ...
    it('should deploy asset-registry contracts', () => __awaiter(this, void 0, void 0, function* () {
        ...
        assetConsumingLogic = new ew_asset_registry_contracts_1.AssetConsumingRegistryLogic(web3, deployedContracts.AssetConsumingRegistryLogic);
    }));
    ...
    it('should onboard a new asset', () => __awaiter(this, void 0, void 0, function* () {
        ...
        chai_1.assert.equal(yield Asset.ConsumingAsset.getAssetListLength(conf), 0);
        const asset = yield Asset.ConsumingAsset.createAsset(assetProps, assetPropsOffChain, conf);
        ...
        chai_1.assert.equal(yield Asset.ConsumingAsset.getAssetListLength(conf), 1);
    }));
    it('should fail when onboarding the same asset again', () => __awaiter(this, void 0, void 0, function* () {
        const assetProps = {
            certificatesUsedForWh: 0,
            smartMeter: { address: assetSmartmeter },
            owner: { address: assetOwnerAddress },
        ...
        try {
            ...
            chai_1.assert.include(e.message, 'smartmeter does already exist');
        }
        chai_1.assert.equal(yield Asset.ConsumingAsset.getAssetListLength(conf), 1);
    }));
    it('should log a new meterreading', () => __awaiter(this, void 0, void 0, function* () {
        ...
        let asset = yield (new Asset.ConsumingAsset.Entity('0', conf).sync());
...
//# sourceMappingURL=AssetConsumingFacade.js.map