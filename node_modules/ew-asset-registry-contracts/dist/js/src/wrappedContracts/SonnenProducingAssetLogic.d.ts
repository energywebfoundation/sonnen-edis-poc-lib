...
export declare class SonnenProducingAssetLogic extends GeneralFunctions {
    ...
    saveSonnenSmartMeterRead(_assetId: number, _newMeterRead: number, _lastSmartMeterReadFileHash: string, _timeFrameFrom: number, _timeFrameTo: number, _averagePower: number, _powerProfileURL: string, txParams?: SpecialTx): Promise<any>;
