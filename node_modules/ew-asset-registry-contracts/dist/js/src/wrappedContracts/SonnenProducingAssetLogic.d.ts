...
export declare class SonnenProducingAssetLogic extends GeneralFunctions {
    web3: Web3;
    buildFile: {
        "abi": ({
            "constant": boolean;
    ...
    addSonnenAssetToSupply(_assetId: number, _supplyId: number, txParams?: SpecialTx): Promise<any>;
    createSonnenAsset(_smartMeter: string, _owner: string, _active: boolean, _matcher: string[], _propertiesDocumentHash: string, _url: string, _numOwnerChanges: number, _marketLookupAddress: string, txParams?: SpecialTx): Promise<any>;
    ...
    setMarketPropsCertOwner(_assetId: number, _owner: string, txParams?: SpecialTx): Promise<any>;
    ...
    getSonnenAssetById(_assetId: number, txParams?: SpecialTx): Promise<any>;
    ...
    getSonnenAssetBySmartMeter(_smartMeter: string, txParams?: SpecialTx): Promise<any>;
    saveSonnenSmartMeterRead(_assetId: number, _newMeterRead: number, _lastSmartMeterReadFileHash: string, _timeFrameFrom: number, _timeFrameTo: number, _averagePower: number, _baselinePower: number, _powerProfileURL: string, txParams?: SpecialTx): Promise<any>;
    getMarketLookupContract(_assetId: number, txParams?: SpecialTx): Promise<any>;
    clearSonnenAsset(_assetId: number, txParams?: SpecialTx): Promise<any>;
