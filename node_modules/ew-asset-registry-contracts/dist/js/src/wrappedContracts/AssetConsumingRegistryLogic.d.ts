...
export declare class AssetConsumingRegistryLogic extends GeneralFunctions {
    web3: Web3;
    buildFile: {
        "abi": ({
            "constant": boolean;
    ...
    createAsset(_smartMeter: string, _owner: string, _active: boolean, _matcher: string[], _propertiesDocumentHash: string, _url: string, txParams?: SpecialTx): Promise<any>;
