...
class AssetContractLookup extends GeneralFunctions_1.GeneralFunctions {
    constructor(web3, address) {
        super(address ? new web3.eth.Contract(AssetContractLookup_json_1.default.abi, address) : new web3.eth.Contract(AssetContractLookup_json_1.default.abi, AssetContractLookup_json_1.default.networks.length > 0 ? (AssetContractLookup_json_1.default.networks[0]) : null));
        this.buildFile = AssetContractLookup_json_1.default;
        this.web3 = web3;
    }
    ...
    assetProducingRegistry(txParams) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this.web3Contract.methods.assetProducingRegistry().call(txParams));
        });
    }
    init(_userRegistry, _assetProducingRegistry, _assetConsumingRegistry, _assetProducingDB, _assetConsumingDB, txParams) {
        return __awaiter(this, void 0, void 0, function* () {
            let transactionParams;
            const txData = yield this.web3Contract.methods.init(_userRegistry, _assetProducingRegistry, _assetConsumingRegistry, _assetProducingDB, _assetConsumingDB)
                .encodeABI();
            let gas;
            if (txParams) {
                ...
                if (!txParams.gas) {
                    try {
                        gas = yield this.web3Contract.methods.init(_userRegistry, _assetProducingRegistry, _assetConsumingRegistry, _assetProducingDB, _assetConsumingDB)
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return yield this.web3Contract.methods.init(_userRegistry, _assetProducingRegistry, _assetConsumingRegistry, _assetProducingDB, _assetConsumingDB)
                    .send({ from: transactionParams.from, gas: transactionParams.gas });
            }
        });
    }
    assetConsumingRegistry(txParams) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this.web3Contract.methods.assetConsumingRegistry().call(txParams));
        });
    }
    ...
    maxMatcherPerAsset(txParams) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this.web3Contract.methods.maxMatcherPerAsset().call(txParams));
        });
    }
    owner(txParams) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    update(_assetProducingRegistry, _assetConsumingRegistry, txParams) {
        return __awaiter(this, void 0, void 0, function* () {
            let transactionParams;
            const txData = yield this.web3Contract.methods.update(_assetProducingRegistry, _assetConsumingRegistry)
                .encodeABI();
            let gas;
            if (txParams) {
                if (txParams.privateKey) {
                ...
                if (!txParams.gas) {
                    try {
                        gas = yield this.web3Contract.methods.update(_assetProducingRegistry, _assetConsumingRegistry)
                            .estimateGas({ from: txParams ? txParams.from : (yield this.web3.eth.getAccounts())[0] });
                    }
                    catch (ex) {
                        if (!(yield GeneralFunctions_1.getClientVersion(this.web3)).includes('Parity'))
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return yield this.web3Contract.methods.update(_assetProducingRegistry, _assetConsumingRegistry)
                    .send({ from: transactionParams.from, gas: transactionParams.gas });
            }
        });
    }
}
exports.AssetContractLookup = AssetContractLookup;
