...
const RoleManagement_json_1 = __importDefault(require("../../contract-build/RoleManagement.json"));
class RoleManagement extends GeneralFunctions_1.GeneralFunctions {
    constructor(web3, address) {
        super(address ? new web3.eth.Contract(RoleManagement_json_1.default.abi, address) : new web3.eth.Contract(RoleManagement_json_1.default.abi, RoleManagement_json_1.default.networks.length > 0 ? (RoleManagement_json_1.default.networks[0]) : null));
        this.buildFile = RoleManagement_json_1.default;
        this.web3 = web3;
    }
