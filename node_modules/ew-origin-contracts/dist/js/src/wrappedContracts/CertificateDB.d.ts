...
export declare class CertificateDB extends GeneralFunctions {
    web3: Web3;
    buildFile: {
        "abi": ({
            "constant": boolean;
    ...
    getCertificate(_certificateId: number, txParams?: SpecialTx): Promise<any>;
    ...
    createCertificateRaw(_assetId: number, _powerInW: number, _escrow: string[], _assetOwner: string, _lastSmartMeterReadFileHash: string, _maxOwnerChanges: number, txParams?: SpecialTx): Promise<any>;
    ...
    createChildCertificate(_parentId: number, _power: number, txParams?: SpecialTx): Promise<any>;
    setTradableToken(_entityId: number, _token: string, txParams?: SpecialTx): Promise<any>;
    setOwnerChangeCounterResetEscrow(_certificateId: number, _newCounter: number, txParams?: SpecialTx): Promise<any>;
