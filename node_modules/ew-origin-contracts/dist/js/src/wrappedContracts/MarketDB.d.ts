...
export declare class MarketDB extends GeneralFunctions {
    ...
    createSupply(_assetId: number[], _regionId: string, _dateTimeFrom: number, _dateTimeTo: number, _power: number, _baselinePower: number, _matchedPower: number, _price: number, txParams?: SpecialTx): Promise<any>;
    ...
    setDemandMatchedPower(_demandId: number, _matchedPower: number, txParams?: SpecialTx): Promise<any>;
    getAllSupplyListLength(txParams?: SpecialTx): Promise<any>;
    owner(txParams?: SpecialTx): Promise<any>;
    createAgreementDB(_demandId: number, _supplyId: number[], txParams?: SpecialTx): Promise<any>;
    ...
    createDemand(_regionId: string, _dateTimeFrom: number, _dateTimeTo: number, _power: number, _matchedPower: number, txParams?: SpecialTx): Promise<any>;
    setSupplyMatchedPower(_supplyId: number, _matchedPower: number, txParams?: SpecialTx): Promise<any>;
