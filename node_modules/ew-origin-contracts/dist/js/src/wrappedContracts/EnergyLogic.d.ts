...
export declare class EnergyLogic extends GeneralFunctions {
    web3: Web3;
    buildFile: {
        "abi": ({
            "constant": boolean;
    ...
    getAllLogCreatedCertificateEvents(eventFilter?: SearchLog): Promise<any>;
    getAllLogTestEvents(eventFilter?: SearchLog): Promise<any>;
    getAllLogFlexibilityCreatedEvents(eventFilter?: SearchLog): Promise<any>;
    ...
    getReportedFlexibility(_id: number, txParams?: SpecialTx): Promise<any>;
    ...
    getEnergyCertificateStruct(_certId: number, txParams?: SpecialTx): Promise<any>;
    ...
    removeEscrow(_certificateId: number, _escrow: string, txParams?: SpecialTx): Promise<any>;
    ...
    approveCertificate(_certificateId: number, txParams?: SpecialTx): Promise<any>;
