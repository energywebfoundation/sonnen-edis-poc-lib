...
const EnergyDB_json_1 = __importDefault(require("../../contract-build/EnergyDB.json"));
class EnergyDB extends GeneralFunctions_1.GeneralFunctions {
    constructor(web3, address) {
        super(address ? new web3.eth.Contract(EnergyDB_json_1.default.abi, address) : new web3.eth.Contract(EnergyDB_json_1.default.abi, EnergyDB_json_1.default.networks.length > 0 ? (EnergyDB_json_1.default.networks[0]) : null));
        this.buildFile = EnergyDB_json_1.default;
        this.web3 = web3;
    }
    ...
    addEscrowForAsset(_entityId, _escrow, txParams) {
        return __awaiter(this, void 0, void 0, function* () {
            let transactionParams;
            const txData = yield this.web3Contract.methods.addEscrowForAsset(_entityId, _escrow)
                .encodeABI();
            let gas;
            if (txParams) {
                if (txParams.privateKey) {
                ...
                if (!txParams.gas) {
                    try {
                        gas = yield this.web3Contract.methods.addEscrowForAsset(_entityId, _escrow)
                            .estimateGas({ from: txParams ? txParams.from : (yield this.web3.eth.getAccounts())[0] });
                    }
                    catch (ex) {
                        if (!(yield GeneralFunctions_1.getClientVersion(this.web3)).includes('Parity'))
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return yield this.web3Contract.methods.addEscrowForAsset(_entityId, _escrow)
                    .send({ from: transactionParams.from, gas: transactionParams.gas });
            }
        });
    }
    setApproved(_entityId, _approved, txParams) {
        return __awaiter(this, void 0, void 0, function* () {
            let transactionParams;
            const txData = yield this.web3Contract.methods.setApproved(_entityId, _approved)
                .encodeABI();
            let gas;
            if (txParams) {
                if (txParams.privateKey) {
                ...
                if (!txParams.gas) {
                    try {
                        gas = yield this.web3Contract.methods.setApproved(_entityId, _approved)
                            .estimateGas({ from: txParams ? txParams.from : (yield this.web3.eth.getAccounts())[0] });
                    }
                    catch (ex) {
                        if (!(yield GeneralFunctions_1.getClientVersion(this.web3)).includes('Parity'))
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return yield this.web3Contract.methods.setApproved(_entityId, _approved)
                    .send({ from: transactionParams.from, gas: transactionParams.gas });
            }
        });
    }
    ...
    setEscrow(_entityId, _escrow, txParams) {
        return __awaiter(this, void 0, void 0, function* () {
            let transactionParams;
            const txData = yield this.web3Contract.methods.setEscrow(_entityId, _escrow)
                .encodeABI();
            let gas;
            if (txParams) {
                if (txParams.privateKey) {
                ...
                if (!txParams.gas) {
                    try {
                        gas = yield this.web3Contract.methods.setEscrow(_entityId, _escrow)
                            .estimateGas({ from: txParams ? txParams.from : (yield this.web3.eth.getAccounts())[0] });
                    }
                    catch (ex) {
                        if (!(yield GeneralFunctions_1.getClientVersion(this.web3)).includes('Parity'))
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return yield this.web3Contract.methods.setEscrow(_entityId, _escrow)
                    .send({ from: transactionParams.from, gas: transactionParams.gas });
            }
        });
    }
    ...
    setFexibility(_entityId, _flex, txParams) {
        return __awaiter(this, void 0, void 0, function* () {
            let transactionParams;
            const txData = yield this.web3Contract.methods.setFexibility(_entityId, _flex)
                .encodeABI();
            let gas;
            if (txParams) {
                if (txParams.privateKey) {
                ...
                if (!txParams.gas) {
                    try {
                        gas = yield this.web3Contract.methods.setFexibility(_entityId, _flex)
                            .estimateGas({ from: txParams ? txParams.from : (yield this.web3.eth.getAccounts())[0] });
                    }
                    catch (ex) {
                        if (!(yield GeneralFunctions_1.getClientVersion(this.web3)).includes('Parity'))
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return yield this.web3Contract.methods.setFexibility(_entityId, _flex)
                    .send({ from: transactionParams.from, gas: transactionParams.gas });
            }
        });
    }
    ...
    setFileHash(_entityId, _fileHash, txParams) {
        return __awaiter(this, void 0, void 0, function* () {
            let transactionParams;
            const txData = yield this.web3Contract.methods.setFileHash(_entityId, _fileHash)
                .encodeABI();
            let gas;
            if (txParams) {
                if (txParams.privateKey) {
                ...
                if (!txParams.gas) {
                    try {
                        gas = yield this.web3Contract.methods.setFileHash(_entityId, _fileHash)
                            .estimateGas({ from: txParams ? txParams.from : (yield this.web3.eth.getAccounts())[0] });
                    }
                    catch (ex) {
                        if (!(yield GeneralFunctions_1.getClientVersion(this.web3)).includes('Parity'))
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return yield this.web3Contract.methods.setFileHash(_entityId, _fileHash)
                    .send({ from: transactionParams.from, gas: transactionParams.gas });
            }
        });
    }
    ...
    createTradableEntityEntry(_assetId, _owner, _powerInW, _flex, txParams) {
        return __awaiter(this, void 0, void 0, function* () {
            let transactionParams;
            const txData = yield this.web3Contract.methods.createTradableEntityEntry(_assetId, _owner, _powerInW, _flex)
                .encodeABI();
            let gas;
            if (txParams) {
                if (txParams.privateKey) {
                ...
                if (!txParams.gas) {
                    try {
                        gas = yield this.web3Contract.methods.createTradableEntityEntry(_assetId, _owner, _powerInW, _flex)
                            .estimateGas({ from: txParams ? txParams.from : (yield this.web3.eth.getAccounts())[0] });
                    }
                    catch (ex) {
                        if (!(yield GeneralFunctions_1.getClientVersion(this.web3)).includes('Parity'))
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return yield this.web3Contract.methods.createTradableEntityEntry(_assetId, _owner, _powerInW, _flex)
                    .send({ from: transactionParams.from, gas: transactionParams.gas });
            }
        });
    }
    ...
    getEnergyCertificate(_entityId, txParams) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this.web3Contract.methods.getEnergyCertificate(_entityId).call(txParams));
        });
    }
...
exports.EnergyDB = EnergyDB;
//# sourceMappingURL=EnergyDB.js.map