...
export declare class EnergyDB extends GeneralFunctions {
    web3: Web3;
    buildFile: {
        "abi": ({
            "constant": boolean;
    ...
    addEscrowForAsset(_entityId: number, _escrow: string, txParams?: SpecialTx): Promise<any>;
    setApproved(_entityId: number, _approved: boolean, txParams?: SpecialTx): Promise<any>;
    ...
    createTradableEntityEntry(_assetId: number, _owner: string, _powerInW: number, _flex: any, txParams?: SpecialTx): Promise<any>;
    setEscrow(_entityId: number, _escrow: string[], txParams?: SpecialTx): Promise<any>;
    getOwnerToOperators(_company: string, _escrow: string, txParams?: SpecialTx): Promise<any>;
    setFexibility(_entityId: number, _flex: any, txParams?: SpecialTx): Promise<any>;
    ...
    setFileHash(_entityId: number, _fileHash: string, txParams?: SpecialTx): Promise<any>;
    changeOwner(_newOwner: string, txParams?: SpecialTx): Promise<any>;
    getCertificateListLength(txParams?: SpecialTx): Promise<any>;
    ...
    getEnergyCertificate(_entityId: number, txParams?: SpecialTx): Promise<any>;
