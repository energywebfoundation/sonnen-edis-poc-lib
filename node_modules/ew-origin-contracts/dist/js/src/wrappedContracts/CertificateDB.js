...
const CertificateDB_json_1 = __importDefault(require("../../contract-build/CertificateDB.json"));
class CertificateDB extends GeneralFunctions_1.GeneralFunctions {
    constructor(web3, address) {
        super(address ? new web3.eth.Contract(CertificateDB_json_1.default.abi, address) : new web3.eth.Contract(CertificateDB_json_1.default.abi, CertificateDB_json_1.default.networks.length > 0 ? (CertificateDB_json_1.default.networks[0]) : null));
        this.buildFile = CertificateDB_json_1.default;
        this.web3 = web3;
    }
    ...
    getCertificate(_certificateId, txParams) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this.web3Contract.methods.getCertificate(_certificateId).call(txParams));
        });
    }
    ...
    createCertificateRaw(_assetId, _powerInW, _escrow, _assetOwner, _lastSmartMeterReadFileHash, _maxOwnerChanges, txParams) {
        return __awaiter(this, void 0, void 0, function* () {
            let transactionParams;
            const txData = yield this.web3Contract.methods.createCertificateRaw(_assetId, _powerInW, _escrow, _assetOwner, _lastSmartMeterReadFileHash, _maxOwnerChanges)
                .encodeABI();
            let gas;
            if (txParams) {
                if (txParams.privateKey) {
                ...
                if (!txParams.gas) {
                    try {
                        gas = yield this.web3Contract.methods.createCertificateRaw(_assetId, _powerInW, _escrow, _assetOwner, _lastSmartMeterReadFileHash, _maxOwnerChanges)
                            .estimateGas({ from: txParams ? txParams.from : (yield this.web3.eth.getAccounts())[0] });
                    }
                    catch (ex) {
                        if (!(yield GeneralFunctions_1.getClientVersion(this.web3)).includes('Parity'))
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return yield this.web3Contract.methods.createCertificateRaw(_assetId, _powerInW, _escrow, _assetOwner, _lastSmartMeterReadFileHash, _maxOwnerChanges)
                    .send({ from: transactionParams.from, gas: transactionParams.gas });
            }
        });
    }
    ...
    createChildCertificate(_parentId, _power, txParams) {
        return __awaiter(this, void 0, void 0, function* () {
            let transactionParams;
            const txData = yield this.web3Contract.methods.createChildCertificate(_parentId, _power)
                .encodeABI();
            let gas;
            if (txParams) {
                if (txParams.privateKey) {
                ...
                if (!txParams.gas) {
                    try {
                        gas = yield this.web3Contract.methods.createChildCertificate(_parentId, _power)
                            .estimateGas({ from: txParams ? txParams.from : (yield this.web3.eth.getAccounts())[0] });
                    }
                    catch (ex) {
                        if (!(yield GeneralFunctions_1.getClientVersion(this.web3)).includes('Parity'))
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return yield this.web3Contract.methods.createChildCertificate(_parentId, _power)
                    .send({ from: transactionParams.from, gas: transactionParams.gas });
            }
        });
    }
    ...
    setOwnerChangeCounterResetEscrow(_certificateId, _newCounter, txParams) {
        return __awaiter(this, void 0, void 0, function* () {
            let transactionParams;
            const txData = yield this.web3Contract.methods.setOwnerChangeCounterResetEscrow(_certificateId, _newCounter)
                .encodeABI();
            let gas;
            if (txParams) {
                if (txParams.privateKey) {
                ...
                if (!txParams.gas) {
                    try {
                        gas = yield this.web3Contract.methods.setOwnerChangeCounterResetEscrow(_certificateId, _newCounter)
                            .estimateGas({ from: txParams ? txParams.from : (yield this.web3.eth.getAccounts())[0] });
                    }
                    catch (ex) {
                        if (!(yield GeneralFunctions_1.getClientVersion(this.web3)).includes('Parity'))
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return yield this.web3Contract.methods.setOwnerChangeCounterResetEscrow(_certificateId, _newCounter)
                    .send({ from: transactionParams.from, gas: transactionParams.gas });
            }
        });
    }
...
exports.CertificateDB = CertificateDB;
//# sourceMappingURL=CertificateDB.js.map