...
const OriginContractLookup_json_1 = __importDefault(require("../../contract-build/OriginContractLookup.json"));
class OriginContractLookup extends GeneralFunctions_1.GeneralFunctions {
    constructor(web3, address) {
        super(address ? new web3.eth.Contract(OriginContractLookup_json_1.default.abi, address) : new web3.eth.Contract(OriginContractLookup_json_1.default.abi, OriginContractLookup_json_1.default.networks.length > 0 ? (OriginContractLookup_json_1.default.networks[0]) : null));
        this.buildFile = OriginContractLookup_json_1.default;
        this.web3 = web3;
    }
    ...
    init(_assetRegistry, _originLogicRegistry, _originDB, txParams) {
        return __awaiter(this, void 0, void 0, function* () {
            let transactionParams;
            const txData = yield this.web3Contract.methods.init(_assetRegistry, _originLogicRegistry, _originDB)
                .encodeABI();
            let gas;
            if (txParams) {
                ...
                if (!txParams.gas) {
                    try {
                        gas = yield this.web3Contract.methods.init(_assetRegistry, _originLogicRegistry, _originDB)
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return yield this.web3Contract.methods.init(_assetRegistry, _originLogicRegistry, _originDB)
                    .send({ from: transactionParams.from, gas: transactionParams.gas });
            }
        });
    }
    update(_originRegistry, txParams) {
        return __awaiter(this, void 0, void 0, function* () {
            let transactionParams;
            const txData = yield this.web3Contract.methods.update(_originRegistry)
                .encodeABI();
            let gas;
            if (txParams) {
                if (txParams.privateKey) {
                ...
                if (!txParams.gas) {
                    try {
                        gas = yield this.web3Contract.methods.update(_originRegistry)
                            .estimateGas({ from: txParams ? txParams.from : (yield this.web3.eth.getAccounts())[0] });
                    }
                    catch (ex) {
                        if (!(yield GeneralFunctions_1.getClientVersion(this.web3)).includes('Parity'))
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return yield this.web3Contract.methods.update(_originRegistry)
                    .send({ from: transactionParams.from, gas: transactionParams.gas });
            }
        });
    }
    setMaxMatcherPerCertificate(_new, txParams) {
        return __awaiter(this, void 0, void 0, function* () {
            let transactionParams;
            const txData = yield this.web3Contract.methods.setMaxMatcherPerCertificate(_new)
                .encodeABI();
            let gas;
            if (txParams) {
                if (txParams.privateKey) {
                ...
                if (!txParams.gas) {
                    try {
                        gas = yield this.web3Contract.methods.setMaxMatcherPerCertificate(_new)
                            .estimateGas({ from: txParams ? txParams.from : (yield this.web3.eth.getAccounts())[0] });
                    }
                    catch (ex) {
                        if (!(yield GeneralFunctions_1.getClientVersion(this.web3)).includes('Parity'))
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return yield this.web3Contract.methods.setMaxMatcherPerCertificate(_new)
                    .send({ from: transactionParams.from, gas: transactionParams.gas });
            }
        });
    }
    ...
    originLogicRegistry(txParams) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this.web3Contract.methods.originLogicRegistry().call(txParams));
        });
    }
    maxMatcherPerCertificate(txParams) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this.web3Contract.methods.maxMatcherPerCertificate().call(txParams));
        });
    }
    owner(txParams) {
        return __awaiter(this, void 0, void 0, function* () {
...
exports.OriginContractLookup = OriginContractLookup;
//# sourceMappingURL=OriginContractLookup.js.map