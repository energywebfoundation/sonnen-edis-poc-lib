...
describe('MarketLogic', () => {
    ...
    it('should create a supply', async () => {
        await marketLogic.createSupply(0, 'Sachsen', Date.now(), Date.now() + 1000, 1000, 100, 10, { privateKey: traderPK });
    ...
    it('should create a 2nd supply', async () => {
        await marketLogic.createSupply(1, 'Sachsen 2', Date.now(), Date.now() + 1000, 1000, 100, 20, { privateKey: traderPK });
