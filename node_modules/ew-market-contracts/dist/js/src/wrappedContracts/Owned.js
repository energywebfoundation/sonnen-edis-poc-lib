...
const Owned_json_1 = __importDefault(require("../../contract-build/Owned.json"));
class Owned extends GeneralFunctions_1.GeneralFunctions {
    constructor(web3, address) {
        super(address ? new web3.eth.Contract(Owned_json_1.default.abi, address) : new web3.eth.Contract(Owned_json_1.default.abi, Owned_json_1.default.networks.length > 0 ? (Owned_json_1.default.networks[0]) : null));
        this.buildFile = Owned_json_1.default;
        this.web3 = web3;
    }
