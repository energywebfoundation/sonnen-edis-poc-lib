...
export declare class SonnenAssetProducingDB extends GeneralFunctions {
    web3: Web3;
    buildFile: {
        "abi": ({
            "constant": boolean;
    ...
    getMarketProperties(_assetId: number, txParams?: SpecialTx): Promise<any>;
    ...
    addFullSonnenAsset(_a: any, txParams?: SpecialTx): Promise<any>;
    ...
    setMarketProperties(_assetId: number, _marketProps: any, txParams?: SpecialTx): Promise<any>;
