...
const UserContractLookup_json_1 = __importDefault(require("../../contract-build/UserContractLookup.json"));
class UserContractLookup extends GeneralFunctions_1.GeneralFunctions {
    constructor(web3, address) {
        super(address ? new web3.eth.Contract(UserContractLookup_json_1.default.abi, address) : new web3.eth.Contract(UserContractLookup_json_1.default.abi, UserContractLookup_json_1.default.networks.length > 0 ? (UserContractLookup_json_1.default.networks[0]) : null));
        this.buildFile = UserContractLookup_json_1.default;
        this.web3 = web3;
    }
