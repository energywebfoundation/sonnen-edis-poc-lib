...
class UserLogic extends GeneralFunctions_1.GeneralFunctions {
    constructor(web3, address) {
        super(address ? new web3.eth.Contract(UserLogic_json_1.default.abi, address) : new web3.eth.Contract(UserLogic_json_1.default.abi, UserLogic_json_1.default.networks.length > 0 ? (UserLogic_json_1.default.networks[0]) : null));
        this.buildFile = UserLogic_json_1.default;
        this.web3 = web3;
    }
